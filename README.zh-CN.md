...
- [TravisLeeeeee/awesome-openclaw-personas](https://github.com/TravisLeeeeee/awesome-openclaw-personas) - 214+ 个生产就绪的 OpenClaw 人格包，覆盖 34 个类别，包含完整的 SOUL.md、AGENTS.md 和 SKILL.md 配置。 [![GitHub stars](https://img.shields.io/github/stars/TravisLeeeeee/awesome-openclaw-personas?style=social)](https://github.com/TravisLeeeeee/awesome-openclaw-personas)
