...
- [clawsocial-plugin](https://github.com/mrpeter2025/clawsocial-plugin) - Social discovery — users find and connect with like-minded people through their OpenClaw agent. Real-time messaging, profile cards, web inbox. ![GitHub stars](https://img.shields.io/github/stars/mrpeter2025/clawsocial-plugin?style=social)
