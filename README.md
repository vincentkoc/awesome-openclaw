...
- [Anmarfar/openclaw-supervisor](https://github.com/Anmarfar/openclaw-supervisor) - Controlled execution lane for OpenClaw. Bounded retry, deterministic arbitration, durable run artifacts, rollback included. ![GitHub stars](https://img.shields.io/github/stars/Anmarfar/openclaw-supervisor?style=social)
