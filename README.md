...
- [Zjianru/web-search-pro](https://github.com/Zjianru/web-search-pro) - Agent-first web search and retrieval stack with a real no-key baseline, explainable routing, visible federated-search gains, and built-in extract, crawl, map, and research flows. [ClawHub](https://clawhub.ai/Zjianru/web-search-pro) ![GitHub stars](https://img.shields.io/github/stars/Zjianru/web-search-pro?style=social)
