...
- [augmentedmike/miniclaw-os](https://github.com/augmentedmike/miniclaw-os) - Batteries-included OpenClaw plugin ecosystem for Mac mini home servers. Includes mc-board (Kanban agent), mc-seo (SEO + rank tracking), mc-email (multi-account email), mc-kb (vector KB), mc-designer (AI image gen), mc-human (VNC desktop control), mc-youtube (video pipeline), mc-substack (blog automation), mc-trust (HMAC verification). Turns OpenClaw into a fully autonomous personal AI OS. ![GitHub stars](https://img.shields.io/github/stars/augmentedmike/miniclaw-os?style=social)
