...
- [omega-memory/omega-memory](https://github.com/omega-memory/omega-memory) - Local-first MCP memory server for AI coding agents with semantic search, knowledge graphs, and multi-agent coordination. ![GitHub stars](https://img.shields.io/github/stars/omega-memory/omega-memory?style=social)
